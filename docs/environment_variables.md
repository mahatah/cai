...
| VENICE_API_KEY             | API key for Venice.ai models (`venice/<model>` ids, see [Venice.ai](providers/venice.md))                                                                                                                                                                                                                                                                                                        | -                                              |
| VENICE_API_BASE            | Base URL for the Venice.ai OpenAI-compatible API                                                                                                                                                                                                                                                                                                                                                 | https://api.venice.ai/api/v1                   |
| VENICE_INCLUDE_SYSTEM_PROMPT | Let Venice merge its own system prompt into requests (`venice_parameters.include_venice_system_prompt`)                                                                                                                                                                                                                                                                                          | false                                          |
